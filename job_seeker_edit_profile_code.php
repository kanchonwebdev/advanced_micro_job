...
if (isset($_POST["submit"])) {
    ...
    if (Functions::$ok_alert == "ok") {
        ...
        if (is_array($_FILES)) {
            ...
            $fileNewName = time().'_'.rand();
            $folderPath = "all_img/";
            $ext = pathinfo($_FILES['u_img_1']['name'], PATHINFO_EXTENSION);
            $imageType = $sourceProperties[2];
        ...
        if (is_array($_FILES)) {
            ...
            $fileNewName = time();
            $folderPath = "all_img/";
            $ext = pathinfo($_FILES['u_img_2']['name'], PATHINFO_EXTENSION);
            $imageType = $sourceProperties[2];
        ...
        if (is_array($_FILES)) {
            ...
            $fileNewName = time();
            $folderPath = "all_img/";
            $ext = pathinfo($_FILES['u_img_3']['name'], PATHINFO_EXTENSION);
            $imageType = $sourceProperties[2];
        ...
        $u_que->update_job_seeker_profile($u_alb_img,$u_alb_img_1, $u_alb_img_2, $u_alb_img_3,$u_location,$u_description);
    } else {
        header("Location: job_seeker_edit_profile.php");
    }
} else {
