...
<body>
    ...
    <?php
        if ($data != false) {
            ...
            //$j_data = $s_que->check_job_apply_2($data2['j_id'])->fetch_assoc();
            //$e_data = $s_que->select_employe_by_u_name($j_data['post_by'])->fetch_assoc();
    ?>

        <div class="single-jobs" id="<?php echo $data2['j_id'] ?>">
            <div class="single-job-container">
                <div class="single-job-right" style="flex-basis: 100%">
