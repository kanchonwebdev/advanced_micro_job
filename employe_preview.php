<?php
    ...
    if (Session::show_value("u_name") != "" || Session::show_value("u_name") != NULL) {
        if (Session::show_value("u_type") == "employer") {
            ...
            if ($_SESSION['employe_data'] == "" || $_SESSION['employe_data'] == NULL) {
    ...
    $data = $s_que->select_employe_sign_info();
            ...
            <div class="job-seeker-header">
                ...
                <div class="job-seeker-header-right">
                    <div class="job-seeker-header-right-header">
                        <h1><?php echo $_SESSION['employe_data'][0]; ?></h1> 
                        <div class="online"><div class="active-dot"></div> Online</div>
                    </div>

                    <h2>Employer</h2>

                    <div style="padding-top: 5px"><?php echo $_SESSION['login_info'][0] ?> - <?php echo $_SESSION['login_info'][1] ?> - <?php echo $_SESSION['employe_data'][4] ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="job-seeker-container">
            <div class="job-seeker-content">
                <div class="job-seeker-content-left">
                    <div class="job-seeker-content-left-header">
                        <img src="all_img/<?php echo $_SESSION['employe_data'][2] ?>" width="100%" height="100%" alt="">
                    </div>
                    ...
                    <div class="job-seeker-content-left-footer">
                        ...
                        <div class="job-seeker-content-left-footer-block">
                            ...
                            <span><?php echo $_SESSION['employe_data'][3] ?></span>
                        </div>
                    </div>
                </div>

                <div class="job-seeker-content-right">
                    <form action="employe_preview_code.php" method="post" class="job-seeker-content-right-header" style="row-gap: 10px;" enctype="multipart/form-data">
                        <p>
            ...
            <div class="job-seeker-about">
                <div class="job-seeker-about-left">
                    <h2>About <?php echo $_SESSION['employe_data'][0] ?></h2>
                </div>

                <div class="job-seeker-about-right">
                    <?php echo $_SESSION['employe_data'][5] ?>
                </div>
            </div>
        </div>
