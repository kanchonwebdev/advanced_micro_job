    ...
    <div class="overlay-menu" id="overlay_menu">
        ...
        <div class="overlay-menu-footer">
            ...
            <div class="overlay-menu-block" id="o_menu_active">
                ...
                <a href="j_job_history.php" id="o_menu_active">Job History</a>
            </div>
            ...
            <div class="job-seeker-right">
                <div class="past-job">
                    <div class="past-job-header">
                        <h1>Active Applications for Username</h1>
                    </div>


                    <?php
                        $a_data = $s_que->select_active_job();
                        if ($a_data != false) {
                    ?>
                    ...
                    <div class="past-job-content">
                        <?php foreach($a_data as $a_data_2){ ?>
                            ...
                            <?php
                                ...
                                $j_data = $s_que->select_job_post_u_name($a_data_2['job_id'])->fetch_assoc();
                            ?>
                            <div class="past-job-block">
                                ...
                                <div class="past-job-block-footer">
                                    ...
                                    <div class="past-job-block-footer-block">
                                        <a href="active_job_details.php?j_id=<?php echo $a_data_2['apply_id']; ?>" class="btn" target="_blank">Follow Up</a>
                                    </div>
                                </div>
                            </div> 
                        <?php } ?>
