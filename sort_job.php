<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($type != "none") {
            if ($type == "new") {
                $data = $s_que->select_new_job_post();
            }else {
                $data  = $s_que->select_new_employe($type);
            }
        }
        ...
        if($type == "new"){
            ...
            if ($data != false) {
                ...
                foreach($data as $data3){
                    $data5 = $s_que->select_job_post_by_u_name($data3['u_name']);
                ...
                echo '<p style="text-align: center">No Job Found</p>';
            }
        }
        echo $html;
    }
