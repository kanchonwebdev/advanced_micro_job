...
<html lang="en">
   <head>
      ...
      <title>Jobseeker Profile Setup</title>
      <link rel="stylesheet" href="css/job_seeker_profile_set_up.css">
   ...
   <body>
      <div class="job-seeker">
         <form method="POST" action="job_seeker_profile_set_up_code.php" class="job-seeker-container" enctype="multipart/form-data">
            <div class="job-seeker-header">
               <h1>Welcome to PartiPpl!</h1>
            ...
            <div class="job-seeker-content">
               <div class="job-seeker-left">
                  ...
                  <div class="job-seeker-block" id="job-seeker-block">
                     <p>Interested in Work as:</p>

                     <div class="job-seeker-block-content">
                        <div><input type="checkbox" name="j_interest[]" id="satff1" class="checkbox" value="Waitstaff"> <label for="satff1">Waitstaff</label></div>
                        <div><input type="checkbox" name="j_interest[]" id="satff2" class="checkbox" value="Promotions"> <label for="satff2">Promotions</label></div>
                        <div><input type="checkbox" name="j_interest[]" id="satff3" class="checkbox" value="Bartender"> <label for="satff3">Bartender</label></div>
                        <div><input type="checkbox" name="j_interest[]" id="satff4" class="checkbox" value="Entertainer/Co Host"> <label for="satff4">Entertainer/Co-Host</label></div>
                     </div>
                  </div>

                  <?php if(Session::show_value("j_interest") != "" || Session::show_value("j_interest") != NULL){ ?>
                     <div class="err_bg" onclick="this.style.display='none'">
                        <?php echo Session::show_value("j_interest"); ?>
                     </div>
                  <?php } ?>
               </div>
...
<?php
    ...
    Session::set_value("j_interest", NULL);
