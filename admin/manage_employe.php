        ...
        <div class="job-seeker-container">
            <div class="job-seeker-right">
                <div class="job-content">
                    <div class="job-content-block">Employe Name</div>
                ...
                <?php if($data != false){ ?>
                    <?php foreach($data as $result){ ?>
                        <form method="POST" action="manage_employe_code.php" class="job-content">
                            <div class="job-content-block"><?php echo $result['e_name']; ?></div>
                            <div class="job-content-block"><?php echo $result['e_date']; ?></div>
                            <div class="job-content-block"><?php echo $result['e_status']; ?></div>
                            <input type="hidden" name="e_status" value="<?php echo $result['e_status']; ?>">
                            <input type="hidden" name="e_id" value="<?php echo $result['e_id']; ?>">
