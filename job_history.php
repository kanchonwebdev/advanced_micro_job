   ...
   <div class="overlay-menu" id="overlay_menu">
      ...
      <div class="overlay-menu-footer">
         ...
         <div class="overlay-menu-block" id="o_menu_active">
               ...
               <a href="job_history.php" id="o_menu_active">Job History</a>
         </div>
      ...
      <div class="job-seeker-container">
         <div class="job-seeker-right">
            <div class="active-job">
               ...
               <?php
                  $data = $s_que->select_all_job_active_job();
                  if ($data != false) {
               ...
               <div class="active-job-content">
                  ...
                  <?php foreach($data as $data4){ ?>
                     ...
                     <a href="job_history_details.php?a_id=<?php echo $data2['j_id'] ?>" target="_blank" style="text-decoration: none;color: black;" class="active-job-block">
               ...
               <?php }else{ ?>
                  <h2 style="text-align: center">Oops!! No Active Job Found</h2>
               <?php } ?>
            </div>
         </div>
      </div>
