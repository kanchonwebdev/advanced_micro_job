...
<head>
   ...
   <title>Job Seeker: Active Applications</title>
      ...
      <div class="job-seeker-container">   
         <div class="job-seeker-right">
            <div class="active-job">
               ...
               <?php
                  $data = $s_que->select_all_job_by_u_name();
                  if ($data != false) {  
               ?>
               ...
               <div class="active-job-content">
                  <?php foreach($data as $data2){ ?>
                     ...
                     <a href="employer_active_job.php?j_id=<?php echo $data2['j_id'] ?>" target="_blank" style="text-decoration: none;color: black;" class="active-job-block">
