    ...
    <?php if(Session::show_value("u_type") == "employer"){ ?>
        ...
        <div class="overlay-menu" id="overlay_menu">
            ...
            <div class="overlay-menu-block" id="o_menu_active">
                    ...
                    <a href="change_password.php" id="o_menu_active">Reset Password</a>
            </div>
            ...
            <div class="sign-content">
                <div class="sign-left">
                    <div class="sign-left-header">
                        <h2>Change Password at PartiPpl.</h2>
                    </div>
                ...
                <form action="change_pass_code.php" method="post" class="sign-right">
                    <div class="sign-right-header">

                        <?php if(Session::show_value("change_pass_msg") != "" || Session::show_value("change_pass_msg") != NULL){ ?>
                            <div class="suc_bg" onclick="this.style.display='none'">
                                <?php echo Session::show_value("change_pass_msg"); ?>
                            </div>
                        <?php } ?>

                        <div class="sign-right-header-block">
                            <input type="password" name="o_pass" id="" placeholder="Old Password" class="text-field">
                        </div>

                        <?php if(Session::show_value("o_pass") != "" || Session::show_value("o_pass") != NULL){ ?>
                            <div class="err_bg" onclick="this.style.display='none'">
                                <?php echo Session::show_value("o_pass"); ?>
                            </div>
                        <?php } ?>
...
<?php 
    Session::set_value("change_pass_msg", NULL);
    Session::set_value("o_pass", NULL);
